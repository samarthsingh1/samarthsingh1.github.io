...
<div align="center" style="background-color: #f7f7f7; padding: 20px; border-radius: 10px;">
    <img src="[https://via.placeholder.com/120x120](https://drive.google.com/file/d/19QfJj2AkYEdMh8rZsHEE6ZBw7IycPKiU/view?usp=drive_link)" alt="Profile Picture" style="border-radius: 50%; box-shadow: 0px 4px 6px rgba(0,0,0,0.1);" />
